 ...
 */
contract FeeneyToken is StandardToken, BurnableToken, Airdrop {

  
  string public constant name = "FeeneyToken"; // solium-disable-line uppercase
  string public constant symbol = "FEC"; // solium-disable-line uppercase
